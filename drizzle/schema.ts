...
/**
 * Video Analysis Jobs table - 動画解析ジョブ
 */
...
/**
 * Video Tracking Data table - 動画解析の生データ
 */
...
/**
 * Analyzed Events table - 解析済みイベント
 */
export const analyzedEvents = pgTable("analyzedEvents", {
  ...
  description: text("description"),
  rawData: text("rawData"), // JSON形式で元データを保存
